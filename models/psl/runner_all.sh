...
python3 models/psl/eval/generate_setting_rule_table.py --dir no_inter
...
python3 models/psl/eval/generate_setting_rule_table.py --dir excerpt_article

python3 models/psl/run_inference.py --s inter_article
python3 models/psl/eval/evaluate_inference.py --s inter_article
python3 models/psl/eval/generate_setting_rule_table.py --dir inter_article
